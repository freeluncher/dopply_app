...
class AccountApiServiceDoctor {
  ...
  Future<bool> changeEmail({required String newEmail}) async {
    ...
    try {
      final response = await http.patch(
        Uri.parse('$_baseUrl/doctor/account/email'),
        headers: {
      ...
      print('[AccountApiServiceDoctor] changeEmail Exception: $e');
    }
    return false;
  }
  ...
  Future<bool> changePassword({
    ...
    try {
      final response = await http.patch(
        Uri.parse('$_baseUrl/doctor/account/password'),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
        },
      ...
      print('[AccountApiServiceDoctor] changePassword Exception: $e');
    }
    return false;
  }
}
